...
namespace BugNET.Common
{
    ...
    {
        /// <summary>
        /// BugNet specific status codes from the data provider
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataAccessException"/> class 
        /// with the specified error message status code and InnerException property.
        /// </summary>
        /// <param name="message">The message to display to the client when the exception is thrown.</param>
        /// <param name="statusCode">The Status Code to display when the exception is thrown</param>
        /// <param name="innerException">The InnerException, if any, that threwthe current exception.</param>
        public DataAccessException(string message, int statusCode, Exception innerException)
            : base(message, innerException)
        {
