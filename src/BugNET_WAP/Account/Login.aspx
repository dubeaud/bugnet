<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BugNET.Account.Login" meta:resourcekey="Page" Async="true" %>
            ...
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="UserName" Text="<%$ Resources:SharedResources, UserName%>" CssClass="col-md-2 control-label">User name</asp:Label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="Password" CssClass="text-danger validation-error" ErrorMessage="<%$ Resources:SharedResources, PasswordRequiredErrorMessage%>" />
                        </div>
                    </div>
                    <div class="form-group">
