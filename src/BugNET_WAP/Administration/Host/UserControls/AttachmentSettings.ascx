...
<div class="form-horizontal">
    <div class="form-group">        
            <asp:Label ID="lblAllowedFileExtentions" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="AllowedFileExtentions"
        ...
        <div class="form-group">
            <asp:Label ID="lblFileSizeLimit" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="FileSizeLimit"
