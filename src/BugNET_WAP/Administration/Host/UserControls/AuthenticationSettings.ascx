    ...
    <ContentTemplate>
        <div class="form-horizontal">
            <div class="form-group">
                <asp:Label ID="label2" runat="server" CssClass="col-md-4 control-label" AssociatedControlID="UserAccountSource" Text="<%$ Resources:UserAccountSource %>" />
                <div class="col-md-8">
            ...
            <div class="form-group">
                <asp:Label ID="label8" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="UserRegistration"
            ...
            <div class="form-group" id="trADPath" runat="server">
                <asp:Label ID="label25" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="ADPath" Text="<%$ Resources:DomainPath %>" />
                <div class="col-md-8">
                    <asp:TextBox ID="ADPath" CssClass="form-control" runat="Server" />
                </div>
            </div>
            <div class="form-group" id="trADUserName" runat="server">
                <asp:Label ID="label4" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="ADUserName" Text="<%$ Resources:SharedResources, Username %>" />
                <div class="col-md-8">
                    <asp:TextBox ID="ADUserName" CssClass="form-control" runat="Server" />
                </div>
            </div>
            <div class="form-group" id="trADPassword" runat="server">
                <asp:Label ID="label5" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="ADPassword" Text="<%$ Resources:SharedResources, Password %>" />
                <div class="col-md-8">
                    <asp:TextBox TextMode="Password" ID="ADPassword" CssClass="form-control" runat="Server" />
                </div>
            </div>
            <div class="form-group">
                <asp:Label ID="label7" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="AnonymousAccess"
            ...
            <div class="form-group">
                <asp:Label ID="label3" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="FacebookAppId"
            ...
            <h4>Twitter</h4>
            <div class="form-group">
                <asp:Label ID="label9" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="TwitterAuthentication" Text="<%$ Resources:SharedResources, Enable %>" />
                <div class="col-md-8">
                    <div class="checkbox">
            ...
            <div class="form-group">
                <asp:Label ID="label10" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="TwitterConsumerKey"
            ...
            <div class="form-group">
                <asp:Label ID="label11" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="TwitterConsumerSecret"
            ...
            <h4>Google</h4>
            <div class="form-group">
                <asp:Label ID="label12" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="GoogleAuthentication" Text="<%$ Resources:SharedResources, Enable %>" />
                <div class="col-md-8">
                    <div class="checkbox">
