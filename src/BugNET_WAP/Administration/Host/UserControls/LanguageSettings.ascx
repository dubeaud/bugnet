<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LanguageSettings.ascx.cs"
    Inherits="BugNET.Administration.Host.UserControls.LanguageSettings" %>
<h2>
...
<div class="fieldgroup noborder">
    ...
    <ol>
        <li>
            <asp:Label ID="label28" runat="server" AssociatedControlID="ApplicationDefaultLanguage"
                Text="<%$ Resources:ApplicationDefault %>" />
            <asp:DropDownList ID="ApplicationDefaultLanguage" DataTextField="Text" DataValueField="Value"
                runat="server" />
        </li>
    </ol>
    <p style="margin: 0 0 0.5em 0">
        <asp:Localize runat="server" ID="InstalledLanguages" Text="<%$ Resources:InstalledLanguages %>" /></p>
        <asp:GridView ID="LanguagesGridView" AutoGenerateColumns="false" SkinID="GridView"
