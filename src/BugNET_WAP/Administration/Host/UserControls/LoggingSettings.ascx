...
<div class="form-horizontal">
    <div class="form-group">
        <asp:Label ID="label23" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="EmailErrors" Text="<%$ Resources:EmailErrorMessages %>" />
        <div class="col-md-8">
            <div class="checkbox">
    ...
    <div class="form-group">
        <asp:Label ID="label24" runat="server" AssociatedControlID="ErrorLoggingEmail" CssClass="col-md-4 control-label"
