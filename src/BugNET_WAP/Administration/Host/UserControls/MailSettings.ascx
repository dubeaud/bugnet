    ...
    <ContentTemplate>
        <div class="form-horizontal">
            <div class="form-group">
                <asp:Label ID="lblSMTPServer" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="SMTPServer" Text="<%$ Resources:Server %>" />
                <div class="col-md-7">
            ...
            <div class="form-group">
                <asp:Label ID="lblSMTPPort" runat="server" AssociatedControlID="SMTPPort" CssClass="col-md-4 control-label" Text="<%$ Resources:Port %>" />
                <div class="col-md-8">
                    <asp:TextBox ID="SMTPPort" CssClass="form-control" runat="Server" />
                </div>
            </div>
            <div class="form-group">
                <asp:Label ID="lblHostEmail" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="HostEmail" Text="<%$ Resources:HostEmail %>" />
                <div class="col-md-8">
            ...
            <div class="form-group">
                <asp:Label ID="lblSSL" runat="server" AssociatedControlID="SMTPUseSSL" CssClass="col-md-4 control-label" Text="[SSL]" meta:resourcekey="lblSSL" />
                <div class="col-md-8">
                    <div class="checkbox">
            ...
            <div class="form-group">
                <asp:Label ID="lblSMTPEnableAuthentication" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="SMTPEnableAuthentication" Text="<%$ Resources:EnableAuthentication %>" />
                <div class="col-md-8">
                    <div class="checkbox">
            ...
            <div class="form-group" id="trSMTPUsername" runat="server">
                <asp:Label ID="lblSMTPUsername" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="SMTPUsername" Text="<%$ Resources:SharedResources, Username %>" />
                <div class="col-md-8">
                    <asp:TextBox ID="SMTPUsername" CssClass="form-control" runat="Server" />
                </div>
            </div>
            <div class="form-group" id="trSMTPPassword" runat="server">
                <asp:Label ID="lblSMTPPassword" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="SMTPPassword" Text="<%$ Resources:SharedResources, Password %>" />
                <div class="col-md-8">
            ...
            <div class="form-group" id="trSMTPDomain" runat="server">
                <asp:Label ID="lblSMTPDomain" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="SMTPDomain" Text="[Domain]" meta:resourcekey="lblSMTPDomain" />
                <div class="col-md-8">
                    <asp:TextBox ID="SMTPDomain" CssClass="form-control" runat="Server" /></div>
            </div>
            <div class="form-group">
                <asp:Label ID="lblSMTPEmailFormat" runat="server" AssociatedControlID="SMTPEmailFormat" CssClass="col-md-4 control-label" Text="<%$ Resources:EmailFormat %>" />
                <div class="col-md-8">
            ...
            <div class="form-group">
                <asp:Label ID="lblSMTPEmailTemplateRoot" CssClass="col-md-4 control-label" runat="server" AssociatedControlID="SMTPEmailTemplateRoot" Text="<%$ Resources:EmailTemplateRoot %>" />
                <div class="col-md-8">
