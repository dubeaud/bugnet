    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" CssClass="text-danger" ErrorMessage="<%$ Resources:DisplayNameRequiredErrorMessage %>"
                    ControlToValidate="DisplayName" Display="Dynamic"></asp:RequiredFieldValidator>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-8">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$ Resources:SharedResources, EmailRequiredErrorMessage %>"
                    ControlToValidate="Email" Display="Dynamic" CssClass="text-danger"></asp:RequiredFieldValidator>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="form-group">
                    <asp:Label ID="Label41" AssociatedControlID="ConfirmPassword" CssClass="control-label col-md-4" runat="server" Text="<%$ Resources:SharedResources, ConfirmPassword %>" />
                    <div class="col-md-8">
                        ...
                        <asp:CompareValidator ID="cvPassword"
                            ...
                            runat="server" ErrorMessage="<%$ Resources:SharedResources, ConfirmPasswordMismatchErrorMessage %>"></asp:CompareValidator>
                    </div>
                </div>
            </ContentTemplate>
            <Triggers>
