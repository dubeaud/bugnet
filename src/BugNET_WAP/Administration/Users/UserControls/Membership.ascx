...
<div class="form-horizontal">
    <div class="form-group">
        <asp:Label ID="Label2" CssClass="col-md-2 control-label" AssociatedControlID="UserName" runat="server" Text="<%$ Resources:SharedResources, Username %>" />
        <div class="col-md-10">
    ...
    <div class="form-group">
        <asp:Label ID="Label4" CssClass="col-md-2 control-label" AssociatedControlID="Email" runat="server" Text="<%$ Resources:SharedResources, Email %>" />
        <div class="col-md-10">
    ...
    <div class="form-group">
        <asp:Label ID="Label9" AssociatedControlID="LockedOut" CssClass="col-md-2 control-label" runat="server" Text="<%$ Resources:LockedOut %>" />
        <div class="col-md-10">
            <div class="checkbox">
    ...
    <div class="form-group">
        <asp:Label ID="Label10" AssociatedControlID="Authorized" CssClass="col-md-2 control-label" runat="server" Text="<%$ Resources:SharedResources, Authorized %>" />
        <div class="col-md-10">
            <div class="checkbox">
    ...
    <div class="form-group">
        <asp:Label ID="Label12" AssociatedControlID="Online" CssClass="col-md-2 control-label" runat="server" Text="<%$ Resources:UserIsOnline %>" />
        <div class="col-md-10">
            <div class="checkbox">
