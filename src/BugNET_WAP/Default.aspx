...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-12">
        <div class="row">
            <div class="col-sm-3">
                  <h3><asp:Label ID="lblApplicationTitle" runat="server">BugNET Issue Tracker</asp:Label></h3>
                <p>
                        ...
                        <div class="row">    
                            <div class="col-md-2 col-sm-3 text-center">
                                <a href="Projects/ProjectSummary.aspx?pid=<%# ((Project)Container.DataItem).Id %>">
                                    <asp:Image CssClass="img-rounded" runat="server" Height="90" Width="90" AlternateText="<%# ((Project)Container.DataItem).Name %>" ID="ProjectImage" />
                                </a>
                            </div>
                            <div class="col-md-10 col-sm-9">
                                ...
                                <div>
                                    <ul class="list-inline">
                                        <li><asp:Label CssClass="issues" ID="OpenIssues" runat="Server" /></li>
                                        <li><asp:Label ID="NextMilestoneDue" CssClass="nextMilestone" runat="Server" /></li>
                                        <li><asp:Label ID="MilestoneComplete" CssClass="progressBar" runat="Server" /></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
