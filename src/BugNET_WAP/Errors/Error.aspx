<%@ Page Language="C#" MasterPageFile="~/Shared/SingleColumn.master" AutoEventWireup="true" Inherits="BugNET.Errors.Error" Title="<%$ Resources:ApplicationError %>" Codebehind="Error.aspx.cs" %>
