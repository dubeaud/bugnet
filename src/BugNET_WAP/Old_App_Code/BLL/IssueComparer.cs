        ...
        public int Compare(Issue x, Issue y) {
          ...
          switch (_sortColumn) {
            ...
            case "DueDate":
              ...
              break;
            case "Category":
              retVal = (int)(x.CategoryId - y.CategoryId);
              break;
            case "Description":
            ...
            case "LastUpdateUser":
              ...
              break;
            case "IssueType":
              retVal = (int)(x.IssueTypeId - y.IssueTypeId);
              break;
            case "Milestone":
              retVal = (int)(x.MilestoneId - y.MilestoneId);
              break;
            case "AffectedMilestone":
                retVal = (int)(x.AffectedMilestoneId - y.AffectedMilestoneId);
                break;
            case "Status":
              retVal = (int)(x.StatusId- y.StatusId);
              break;
            case "Priority":
              retVal = (int)(x.PriorityId - y.PriorityId);
              break;
            case "TimeLogged":
              retVal = (int)(x.TimeLogged - y.TimeLogged);
              break;
            case "Votes":
              retVal = (int)(x.Votes - y.Votes);
              break;
            case "Title":
