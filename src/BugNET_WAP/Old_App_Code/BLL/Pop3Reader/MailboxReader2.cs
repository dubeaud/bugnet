...
using BugNET.BLL;
using BugNET.BusinessLogicLayer.POP3Client;
...
namespace BugNET.BusinessLogicLayer.POP3Reader
{
    ...
    public class MailboxReader2
    {
        ...
        private static readonly ILog Log = LogManager.GetLogger(typeof(MailboxReader2));
        ...
        public MailboxReader2(string server,int port,bool useSSL, string userName, string password, bool processInlineAttachedPictures, string bodyTemplate,
