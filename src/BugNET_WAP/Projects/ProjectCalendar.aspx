...
<asp:Content ID="Content3" ContentPlaceHolderID="Content" runat="server">
    <div style="margin: 0 auto;width:850px;">
        ...
        <table style="width:850px;border:0;border-collapse:collapse;">
            ...
            <tr> 
                <td colspan="2">
                    <asp:Calendar ID="prjCalendar" Width="100%" SkinID="Calendar" OnPreRender="prjCalendar_PreRender" OnDayRender="prjCalendar_DayRender" runat="server" meta:resourceKey="Calendar"/>
                </td>
            </tr>
        </table>
    </div>
