<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="Burndown.aspx.cs" Inherits="BugNET.Reports.Burndown" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin: 15px; text-align: center;">
        <asp:Chart ID="Chart1" runat="server" Width="800" Height="375" ImageType="Png">
            ...
            <Series>
                <asp:Series Name="Series1" ChartType="Line" MarkerStep="1" MarkerBorderWidth="0" MarkerStyle="Circle" MarkerSize="8" BorderWidth="2" BorderColor="180, 26, 59, 105" Color="224, 64, 10"></asp:Series>
                <asp:Series Name="Series2" ChartType="Line" MarkerStep="1" MarkerBorderWidth="0" MarkerStyle="Circle" MarkerSize="8" BorderWidth="2" BorderColor="180, 26, 59, 105"></asp:Series>
            </Series>
        </asp:Chart>
    </div>
</asp:Content>
