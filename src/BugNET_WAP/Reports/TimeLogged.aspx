<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="TimeLogged.aspx.cs" Inherits="BugNET.Reports.TimeLogged" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<div style="margin: 15px;text-align:center;">
		<asp:Chart ID="Chart1" runat="server" Width="800" Height="450" ImageType="Png">
			<legends>
		...
		<asp:Chart ID="Chart2" runat="server" Width="800" Height="450" ImageType="Png">
			<legends>
				<asp:legend Enabled="True"  LegendStyle="Row" Docking="Bottom"  Alignment="Far" IsTextAutoFit="False" Name="Default" BackColor="Transparent" Font="Segoe UI, 8.25pt, style=Bold"></asp:legend>
			</legends>
		</asp:Chart>
