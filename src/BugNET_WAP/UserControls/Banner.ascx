        ...
        <LoggedInTemplate>
            <span style="padding-left: 15px;">
                <asp:LinkButton ID="Profile" runat="server" OnClick="Profile_Click" CausesValidation="false">
                    <asp:Image ID="EditProfile" runat="server" CssClass="icon" Style="padding-right: 2px;"
                        Visible="false" ImageUrl="~/images/user.gif" />
    ...
    <asp:Panel ID="Panel1" runat="server" DefaultButton="btnSearch">
        <p id="search">
           ...
           &nbsp;<asp:TextBox ID="txtIssueId" Height="12" Width="80" runat="Server" />
            <asp:LinkButton ID="btnSearch" OnClick="btnSearch_Click" CausesValidation="false"
                runat="server" Text="Search"  meta:resourcekey="btnSearch" />
            &nbsp;|
        </p>
    </asp:Panel>
    <p id="help">
        <a target="_blank" href="http://bugnetproject.com/Documentation/tabid/57/topic/User%20Guide/Default.aspx">
            <asp:Localize runat="server" ID="Help" Text="Help" meta:resourcekey="Help" /></a>
    </p>
</div>
<div id="header">
    <h1 class="title">
        <asp:HyperLink ID="lnkLogo" runat="server" NavigateUrl="~/Default.aspx">
            <asp:Image CssClass="logo" runat="server" SkinID="Logo" ID="Logo" AlternateText="Logo" /><asp:Literal
                ID="AppTitle" runat="server"></asp:Literal>
        </asp:HyperLink>
    </h1>
    <asp:Menu ID="MainMenu"  CssClass="mainMenu" RenderingMode="List"  Visible="false" ClientIDMode="Static" IncludeStyleBlock="false" Orientation="Horizontal"  runat="server"  StaticPopOutImageUrl="~/images/bullet_arrow_down.png" >
    </asp:Menu>
...
<asp:Panel ID="pnlHeaderNav" CssClass="header-nav" runat="server">
    <asp:DropDownList CssClass="header-nav-ddl" ID="ddlProject" OnSelectedIndexChanged="ddlProject_SelectedIndexChanged"
