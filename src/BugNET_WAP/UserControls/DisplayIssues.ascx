...
<table style="border-collapse:collapse;table-layout:fixed;width:100%;border:none;">
		...
		<div style="height:25px;background-color:#F1F2EC;width:100%;">
			...
			<div id="rightButtonContainer" >
				<p id="AddRemoveColumns">
					<a href="#" id="showColumns"><asp:Label ID="Label12" meta:resourcekey="SelectColumnsLinkButton" runat="server"></asp:Label></a>
				</p>
				<p id="ExportExcel">           
		...
		<div id="SetProperties" style="display:none;">
			...
			<div style="margin-left:10px;margin-right:10px;padding-bottom:10px;">
				<table width="100%" style="color:#55555F;">
					<tr>
						<td style="width: 15%;">
							<asp:Label ID="Label1" runat="server" AssociatedControlID="dropCategory:ddlComps" Text="<%$ Resources:SharedResources, Category %>"></asp:Label>:</td>
						<td style="width: 35%;">
							<it:PickCategory ID="dropCategory" DisplayDefault="true" Required="false" runat="server" />
						</td>
						<td style="width: 15%;"><asp:Label ID="Label2" runat="server" AssociatedControlID="dropOwner:ddlUsers" Text="<%$ Resources:SharedResources, Owner %>"></asp:Label>:</td>
						<td style="width: 35%;">
							<it:PickSingleUser ID="dropOwner"  DisplayDefault="true" Required="false" runat="server" />
						</td> 
					</tr>
					<tr>
						<td><asp:Label ID="Label3" runat="server"  AssociatedControlID="dropMilestone:ddlMilestone" Text="<%$ Resources:SharedResources, Milestone %>"></asp:Label>:</td>
						<td>
							<it:PickMilestone ID="dropMilestone"  DisplayDefault="true" Required="false" runat="server" />
						</td>
						 <td><asp:Label ID="Label11" AssociatedControlID="dropAffectedMilestone:ddlMilestone" runat="server" Text="<%$ Resources:SharedResources, AffectedMilestone %>"></asp:Label>:</td>
						<td>
							<it:PickMilestone ID="dropAffectedMilestone"  DisplayDefault="true" Required="false" runat="server" />
						</td>
					</tr>
					<tr>
						<td><asp:Label ID="Label4" runat="server"  AssociatedControlID="dropType:ddlType" Text="<%$ Resources:SharedResources, Type %>"></asp:Label>:</td>
						<td><it:PickType ID="dropType"  DisplayDefault="true" Required="false" runat="server" /></td>
						<td><asp:Label ID="Label5" runat="server"  AssociatedControlID="dropResolution:ddlResolution" Text="<%$ Resources:SharedResources, Resolution %>"/>:</td>
						<td><it:PickResolution id="dropResolution" DisplayDefault="true" Required="false" runat="server"/></td>                 
					</tr>
					<tr>
						<td><asp:Label ID="Label6" runat="server"  AssociatedControlID="dropPriority:ddlPriority"  Text="<%$ Resources:SharedResources, Priority %>"/>:</td>
						<td>                    
							<it:PickPriority ID="dropPriority"  DisplayDefault="true" Required="false" runat="server" />
						</td>
						<td><asp:Label ID="Label7" runat="server"  AssociatedControlID="dropStatus:dropStatus" Text="<%$ Resources:SharedResources, Status %>"/>:</td>
						<td><it:PickStatus ID="dropStatus"  DisplayDefault="true" Required="false" runat="server" /></td> 
					</tr>
					<tr>
				   
						<td><asp:Label ID="Label8" runat="server" AssociatedControlID="dropAssigned:ddlUsers" Text="<%$ Resources:SharedResources, Assigned %>"/>:</td>
						<td><it:PickSingleUser ID="dropAssigned"  DisplayDefault="true" Required="false" runat="server" /></td> 
						<td><asp:Label ID="Label9" runat="server" AssociatedControlID="DueDate:DateTextBox" Text="<%$ Resources:SharedResources, DueDate %>"/>:</td>
						<td>
		...
		<asp:Panel id="SelectColumnsPanel" Visible="False" runat="Server">
		   <div id="ChangeColumns" style="display:none;width:100%;background-color:#FFFAF6;margin-bottom:10px;">
			  ...
			  <div style="margin-left:10px;margin-right:10px;padding-bottom:10px;" >
				...
				<br />
				<asp:Button id="SaveButton" Runat="server" Text="<%$ Resources:SharedResources, Save %>" CssClass="standardText" 
	...
	<asp:Panel  ID="ScrollPanel" runat="server" ScrollBars="Auto" Width="100%" >
		<BNWC:GridView ID="gvIssues" SkinID="GridView" AllowPaging="True"
			AllowSorting="True" BorderWidth="1px" BorderStyle="Solid" GridLines="None"
			DataKeyNames="Id" UseAccessibleHeader="true" EnableMultiColumnSorting="True" ShowSortSequence="True"
			...
			<Columns>
				...
				<asp:HyperLinkField HeaderStyle-HorizontalAlign="Left" HeaderText="<%$ Resources:SharedResources, Title %>" 
                  ...
                  <asp:BoundField DataField="ProjectName" HeaderText="<%$ Resources:SharedResources, Project %>" SortExpression="ProjectName" ItemStyle-Wrap="false" Visible="false">
                    <ItemStyle Wrap="False"></ItemStyle>
                </asp:BoundField>
				...
				<asp:templatefield SortExpression="AffectedMilestoneId" HeaderText="<%$ Resources:SharedResources, AffectedMilestone %>" Visible="false">
					<ItemStyle HorizontalAlign="center" />
					<HeaderStyle HorizontalAlign="center" />
					<itemtemplate>
						<it:TextImage id="ctlAffectedMilestone" ImageDirectory="/Milestone" 
							Text='<%# DataBinder.Eval(Container.DataItem, "AffectedMilestoneName" )%>' 
			   ...
			   <asp:templatefield SortExpression="LastUpdate" HeaderText="<%$ Resources:SharedResources, LastUpdate %>">
				...
				<asp:templatefield SortExpression="LastUpdateUser" HeaderText="<%$ Resources:SharedResources, LastUpdateUser %>"> 
					...
					<FooterTemplate>Test</FooterTemplate>
				</asp:templatefield>
            ...
            <div class="pager">
                <asp:DataPager ID="pager" runat="server" PageSize="10" PagedControlID="gvIssues">
                    <Fields>                  
                        <BNWC:BugNetPagerField   NextPageImageUrl="~/App_Themes/Default/Images/resultset_next.gif" PreviousPageImageUrl="~/App_Themes/Default/Images/resultset_previous.gif" LastPageImageUrl="~/App_Themes/Default/Images/resultset_last.gif"   FirstPageImageUrl="~/App_Themes/Default/Images/resultset_first.gif" />                         
                    </Fields>                            
                </asp:DataPager>
            </div>                
	    </td>
