...
namespace BugNET.Providers.HtmlEditorProviders
{
    ...
    {
        private FCKeditor textbox = new FCKeditor();
        ...
        /// <summary>
        /// Gets the HTML L editor.
        /// </summary>
        /// <value>The HTML L editor.</value>
        ...
        public override void Initialize(string name, System.Collections.Specialized.NameValueCollection config)
        {
            ...
            if (string.IsNullOrEmpty(config["description"]))
            {
                ...
                config.Add("description", "FCKEditorHTMLEditorProvider");
            }
            ...
            // _providerPath = Common.ResolveUrl();
            ...
            if (config["ToolbarSet"] != null)
                textbox.ToolbarSet = config["ToolbarSet"];

            if (config["Skin"] != null)
                textbox.SkinPath = textbox.BasePath + "editor/skins/" + config["Skin"] + "/";
